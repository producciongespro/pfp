<?php
$sql = "SELECT * FROM actividades INNER JOIN planes ON actividades.id_instancia = planes.id_instancia INNER JOIN instancias ON actividades.id_instancia = instancias.id_instancia INNER JOIN estados ON planes.id_estado = estados.id_estado"; 
