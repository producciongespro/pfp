...
<head>
    ...
    <script src="../../js/views/v_detalle_actividad.js"></script>
    <script src="../../js/controller/c_detalle_actividad.js"></script>
</head>
<body>
...
<br>
       <div class="row">
           ...
           <div class="col-6">
                <div class="col-2">                       
                        <i class="far fa-save  btn-edit-activity item-hide item-edit-inactivo"  edit="false" field="tipo"  id="btnselTipo" ></i>
                </div>
           </div>
       </div>
       ...
       <div class="row">
           ...
           <div class="col-2">                       
            ...
            <div class="row">
                ...
                <div class="col-2">                       
                    <i class="far fa-save  btn-edit-activity item-hide item-edit-inactivo" edit="false"  field="area" id="btnselArea" ></i>
                </div>
                ...
                <div class="col-2">                       
                    <i class="far fa-save btn-edit-activity-json item-hide item-edit-inactivo" edit="false" field="estrato" id="btnselEstrato" ></i>
                </div>
                ...
                <div class="col-2">                       
                    <i class="far fa-save  btn-edit-activity item-hide item-edit-inactivo" edit="false" field="modalidad"  id="btnselModalidad" ></i>
                </div>
            ...
            <div class="row">
                        <div class="col">
                                <div class="form-group">
                                        <label for="selEstrategia"><strong>8 -</strong> Estrategia:</label>
                        ...
                        <div class="col">                       
                            <i class="far fa-save btn-edit-activity item-hide item-edit-inactivo" edit="false" field="estrategia" id="btnselEstrategia" ></i>
                        </div>
                        <div class="col">
                        ...
                        <div class="col">                       
                            <i class="far fa-save  btn-edit-activity item-hide item-edit-inactivo" edit="false" field="tipo_actividad" id="btnselTipoActividad" ></i>
                        </div>
                    ...
                    <div class="col">                       
                        <i class="far fa-save btn-edit-activity item-hide item-edit-inactivo" edit="false" field="duracion"  id="btntxtDuracion" ></i>
                    </div>
            </div> 
            <hr>
            <div class="row">
                <div class="col">
                        <div class="alert alert-primary" role="alert">
                                ...
                                &nbsp;  &nbsp;   &nbsp;  
                                <i class="far fa-save  item-edit-inactivo btn-edit-activity-json item-hide " edit="false" field="sede" id="btnJsonGrupos" ></i>
                        </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="form-group">
                             <label for="nmbCantidadParticipantes"> Cantidad de participantes:</label>
                             <input type="number" min="1" class="form-control" id="nmbCantidadParticipantes" >
                    </div>
                </div>
            ...
            <hr>
                    ...
                    <div class="row "  >                        
                        ...
                        <div class="col">                       
                            <i class="far fa-save btn-edit-activity item-hide item-edit-inactivo" edit="false" field="costo"  id="btnnmbCosto" ></i>
                        </div>
                    </div>
